...
$(document).ready(function() {
    if (device.desktop()) {
        var div = "<div id='front-background' style='position:absolute;width:100%;height:100%;z-index:-1;'></div><div id='yt-background'><div id='ytplayer' style='position: absolute;'</div>";
        $(".js-video-header").prepend(div);
    }
});
